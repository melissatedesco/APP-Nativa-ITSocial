...
const makeStyles = (C: ThemeColors, isDark: boolean) => StyleSheet.create({
  ...
  card: {
    ...
    borderRadius: 28, paddingHorizontal: 32, paddingVertical: 40, gap: 20,
  ...
  digitBoxFilled: {
    ...
    backgroundColor: isDark ? 'rgba(91,159,212,0.15)' : '#EFF6FF',
  },
          ...
          <View style={styles.codeRow}>
            {digits.map((d, i) => (
              <TextInput
                key={i}
                ref={refs[i]}
                style={[styles.digitBox, !!error && styles.digitBoxError, d ? styles.digitBoxFilled : null]}
                value={d}
