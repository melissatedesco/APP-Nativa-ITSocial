...
const makeStyles = (C: ThemeColors, isDark: boolean) => StyleSheet.create({
  ...
  card: {
    ...
    borderRadius: 28, paddingHorizontal: 32, paddingVertical: 40, gap: 16,
    shadowColor: '#000', shadowOffset: { width: 0, height: 8 },
    shadowOpacity: isDark ? 0.4 : 0.10, shadowRadius: 32, elevation: 8,
  },
  ...
  errorBox: {
    padding: 12, backgroundColor: C.dangerBg, borderRadius: 12,
    borderWidth: 1, borderColor: isDark ? 'rgba(239,68,68,0.35)' : '#FECACA',
  },
  errorText: { fontSize: 13, color: C.danger, fontWeight: '500' },

  successBox: { gap: 16 },
  successText: {
    padding: 14, borderRadius: 12, fontSize: 13, lineHeight: 20,
  ...
  btn: {
    paddingVertical: 13, backgroundColor: C.primary,
        ...
        <View style={styles.card}>
          ...
          {sent ? (
            <View style={styles.successBox}>
              ...
              <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate('VerificaCodice')}>
